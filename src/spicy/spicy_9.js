...
export const repeatDemo = () => {
    repeat(function(){console.log("Hello, World")}, 10, null)
};
 ...
 */
export const tenTimes = (num) => {return multiplyBy(10)(num)}
...
export const filter = (arr, test) => {
    ...
    return {pass: passArray, fail: failArray}
};
